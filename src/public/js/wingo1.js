    ...
    if ((!isNumber(join) && join == "l") || join == "n") {
      checkJoin = `
                    <div data-v-a9660e98="" class="van-image" style="width: 30px; height: 30px;">
                        <img src="https://ik.imagekit.io/qo15tdum9/images/${
                          join == "n" ? "small" : "big"
                            ...
                            <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                ...
                                <div data-v-a9660e98="" data-clipboard-text="${
                                  list_orders.id_product
                                    ...
                                    ${list_orders.id_product}
                                    <img data-v-a9660e98="" width="18px" height="15px" src="https://ik.imagekit.io/qo15tdum9/images/copy.png" class="m-l-5">
                                </div>
                                </div>
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
...
$(`.game-betting .box .item .img .van-image img`).attr('src', 'https://ik.imagekit.io/qo15tdum9/images/icon_clock-gerrn.webp');
$(`.game-betting .box .item:eq(${selectPageTime - 1}) .img .van-image img`).attr('src', 'https://ik.imagekit.io/qo15tdum9/images/icon_clock-red.webp');